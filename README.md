...
- 7페이지 제출용 PDF 자동 생성
- 근거 데이터에서 3페이지 DOCX·PDF 이력서 자동 생성
...
- `resume:verify`: 근거 참조, 개인정보, DOCX 구조, 3페이지 레이아웃과 프로젝트 비중 검증
- `resume:verify:submission`: 제출용 파일의 연락처와 3페이지 레이아웃 검증
