...
slug: "workshield-web"
contentType: "project"
summary: "사용자가 계약서를 올리고 오래 걸리는 검토의 진행과 근거를 확인해야 하는 출시 전 웹 서비스입니다. 같은 요청의 반복, 취소와 완료의 경쟁, 처리 중단을 백엔드 상태로 관리하고 질문 대상과 출처도 백엔드가 확정하도록 했습니다. API와 배포 구조를 담당해 자동 검증을 구성했으며, 단일 서버에서 보장하지 못하는 범위를 함께 명시했습니다."
