...
summary: "PG와 인앱 결제를 하나의 API 흐름으로 처리하고 외부 승인과 내부 재화 제공 상태를 분리했습니다. PURCHASED 상태와 Redis 정보가 남아 있는 미완료 주문을 식별해 다시 처리하는 복구 배치를 구현했습니다."
...
caseSummary:
  ...
  result: "미완료 PURCHASED 주문을 Redis TTL 안에서 식별·재처리하고, 여러 WAS에서 복구 스케줄러가 동시에 실행되는 것을 ShedLock으로 제한했습니다."
